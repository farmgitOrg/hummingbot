  ...
  getBridgeToken(
    ...
    if (baseToken.chainId === 42161 && quoteToken.chainId === 42161){
        if (
            ...
            (baseToken.symbol?.toUpperCase() === "PLS" && quoteToken.symbol?.toUpperCase().startsWith("USD")) ||
            (quoteToken.symbol?.toUpperCase() === "PLS" && baseToken.symbol?.toUpperCase().startsWith("USD"))
        ){
            //bridge with WETH
            address = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1"
        }
